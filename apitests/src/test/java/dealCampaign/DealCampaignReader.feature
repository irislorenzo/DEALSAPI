#Author: jeugenio
Feature: Deal Campaign Entity validation Reader Role
  ...
  Scenario: Create deal campaign Reader
  ...
  Scenario: Create a deal campaign without campaign name Reader
    Given path 'api/deal-campaign'
    When request
      """
{
  ...
  Scenario: Create a deal campaign without Campaign Description Reader
    Given path 'api/deal-campaign'
    When request
      """
{
  ...
  Scenario: Create a deal campaign without Check In Days Reader
      ...
      """
{
  ...
  Scenario: Create a deal campaign without Accommodation Inclusion Condition Reader
    Given path 'api/deal-campaign'
    When request
      """
{
  ...
  Scenario: Create a deal campaign without Campaign Code Reader
    Given path 'api/deal-campaign'
    When request
      """
{
  ...
  Scenario: Get Deal Campaign and retrieve single status Reader
  ...
  Scenario: Get Deal Campaign and retrieve single status for G'day parks Reader
    ### Get individual campaign
  ...
  Scenario: Create Deal Campaign with invalid Discount Structure Reader
    ### Create a new deal campaign 
    * set dealCampaign.campaignCode = campaignCode
  ...
  Scenario: Create Deal Campaign without Discount Structure Reader
    ### Create a new deal campaign 
    * set dealCampaign.campaignCode = campaignCode
  ...
  Scenario: Create Deal Campaign without Campaign Name, Campaign Code, and Campaign Description Reader
    ### Create a new deal campaign 
